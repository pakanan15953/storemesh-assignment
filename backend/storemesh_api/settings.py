"""
Django settings for storemesh_api project.
...
SECRET_KEY = 'django-insecure-q7@a@#=*hlm()_s#5&jf%i#+trhj^p^jozm%rujays!be7j-oc'
...
ROOT_URLCONF = 'storemesh_api.urls'
...
WSGI_APPLICATION = 'storemesh_api.wsgi.application'
